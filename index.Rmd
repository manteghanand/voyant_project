...
Colocates:
When first presented with the colocation data, voyant throws pairings with the most used word within the corpus, which in this case is “said” . Instead of completely ignoring that and searching for specific terms, we decided to use the huge amount of data available for “said” to our advantage. Here’s our thought process:
